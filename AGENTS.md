...
- Бумажные позиции живут в localStorage (`paper:positions:v1`). Стоп и TP3 закрывают автоматически
  (материализация в PaperPage/Detail), TP1/TP2 — достигнутые уровни. Открытые переоцениваются по живым тикерам.
